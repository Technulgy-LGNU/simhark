use core_dump::proto::{CpMode, InterfaceCommandCp, InterfaceGameCp, InterfaceManualCp, InterfaceTestCp, InterfaceWrapperCp};
...
pub fn interface_command(team: TeamColor) -> InterfaceWrapperCp {
    let (team_color, side) = match team {
        TeamColor::Yellow => (false, true),
        TeamColor::Blue => (true, false),
    };
    InterfaceWrapperCp {
